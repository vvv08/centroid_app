...
import "./addOperators.scss";
import { useNavigate } from "react-router-dom";
import { addOperatorMaster } from "../../../../repository/master";

const AddOperatorsMaster = () => {
  ...
  return (
    <>
      <div className="centroid_addOperatorsWrapper">
        <div className="centroid_addOperatorsContainer">
          <form onSubmit={handleSubmit}>
            <div className="centroid_addOperators_input">
              <label htmlFor="name">Name</label>
              <input id="name" type="text" required onChange={handleInputChange} value={inputs.name}/>
            </div>
            <div className="centroid_addOperators_list">
...
export default AddOperatorsMaster;
