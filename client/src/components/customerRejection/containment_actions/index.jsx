...
const ContainmentActions = ({ data, invoice_id }) => {
                ...
                data.map((obj) => {
                  return(
                    <tr key={obj.containment_id}>
                      ...
                      <td><EditIcon style={{"fontSize":"22px","cursor":"pointer"}} onClick = {() => {navigate(`/customer/editContainment/${obj.containment_id}`)}}/></td>
                    </tr>
                  )
                })
              }
