...
import "./addPreventiveActionComp.scss";
import { useNavigate } from "react-router-dom";
import Select from 'react-select';
import { addPreventiveAction, getInspectorsCAPA, getIssuesByInvoice } from "../../../../repository/customerRejection/capa";

const AddPreventiveActionComp = ({invoice_id}) => {
  ...
  const handleSubmit = (e) => {
         e.preventDefault();
         setLoading(true);
         addPreventiveAction(inputs)
           .then((result) => {
             alert("Preventive action added");
             window.history.back()
           })
           .catch((err) => {
  ...
  return (
    <>
      <div className="centroid_addPreventiveActionWrapper">
        <div className="centroid_addPreventiveActionContainer">
          <form onSubmit={handleSubmit}>
            <div className="centroid_addPreventiveAction_search_list">
            ...
            <div className="centroid_addPreventiveAction_input">
...
export default AddPreventiveActionComp;
