            ...
            <ul>
              ...
              <Link
                ...
                style={{
                  textDecoration: "none",
                  fontWeight: "500",
                  color: `var(${getColor("rejectionEntry")})`,
                }}
              >
                <li>Rejection Entry</li>
              </Link>
              <Link
                to="/downtimeDashboard"
                style={{
                  textDecoration: "none",
                  fontWeight: "500",
                  color: `var(${getColor("downtime")})`,
                }}
              >
                <li>Downtime</li>
              </Link>
              ...
              <Link
                ...
                style={{
                  textDecoration: "none",
                  fontWeight: "500",
                  color: `var(--centroidMaroon_dark)`,
                }}
              >
                <li>Customer Rejection</li>
              </Link>
              {logged_user.type === "admin" && (
                <Link
                  to="/userList"
                  style={{
                    textDecoration: "none",
                    fontWeight: "500",
                    color: `var(${getColor("users")})`,
                  }}
                >
                  <li>User list</li>
                </Link>
